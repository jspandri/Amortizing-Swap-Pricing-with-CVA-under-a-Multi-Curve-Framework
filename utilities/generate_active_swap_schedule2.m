function activeSchedule = generate_active_swap_schedule2(settlement, rawSchedule, estrCurve, euriborCurve)
...
%
% INPUTS:
%   settlement   - Current valuation date (datenum)
%   rawSchedule  - Struct containing the FULL original swap schedule from Excel
%                  (.accrualStart, .accrualEnd, .payDates, .delta, .notionals)
...
%
% OUTPUTS:
%   activeSchedule - Struct ready for pricing, containing only future cash flows.
