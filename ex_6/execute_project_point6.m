...
%   maturity_date_not_adjusted : [Scalar] Unadjusted maturity date.
%   precision_levels           : [Vector] Tree steps per year.
%   notional_amortized         : [Vector] Amortizing notional for the Swap.
...
%                                  .Risky_Swap_Price 
    ...
    res_300_const = run_hw_pricing_amortizing_swap_CVA(a_param, sigma_const, sigma_times, K_strike, ...
    ...
    res_300_pwc = run_hw_pricing_amortizing_swap_CVA(a_param, sigma_pwc, sigma_times, K_strike, ...
        settlement, maturity_date_not_adjusted, precision_levels, notional_amortized, ...
        RecoveryRate, HazardRates(1), discountCurve, pseudoCurve);
    ...
    % Pricing using Constant Sigma
    res_500_const = run_hw_pricing_amortizing_swap_CVA(a_param, sigma_const, sigma_times, K_strike, ...
        settlement, maturity_date_not_adjusted, precision_levels, notional_amortized, ...
        RecoveryRate, HazardRates(2), discountCurve, pseudoCurve);
        
    % Pricing using Piecewise Constant (PWC) Sigma
    res_500_pwc = run_hw_pricing_amortizing_swap_CVA(a_param, sigma_pwc, sigma_times, K_strike, ...
        settlement, maturity_date_not_adjusted, precision_levels, notional_amortized, ...
        RecoveryRate, HazardRates(2), discountCurve, pseudoCurve);
